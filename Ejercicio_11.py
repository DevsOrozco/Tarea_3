...
def EsBisiesto(anio):
    if anio%4==0 and (anio%100!=0 or anio%400==0):#Se plantea una funcion de 3 condiciones: Si el año es divisible para cuatro y es divisible para 400 o no es divisible para 100.
